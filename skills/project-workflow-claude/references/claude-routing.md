...
| Signal | Action |
|--------|--------|
| 实现, implement, 写代码, build | → Phase 4: `Workflow(scriptPath='.claude/workflows/phase4-implement.js')` |
| 审阅, review, 检查代码, code review | → Phase 5: `Workflow(scriptPath='.claude/workflows/phase5-review.js')` |
| 验证, verify, 测试, test, check | → Phase 6: `Workflow(scriptPath='.claude/workflows/phase6-verify.js')` |
