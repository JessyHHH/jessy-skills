...
See [references/companion_tooling.md](references/companion_tooling.md). Tools: extractor + generator + tracker. In Codex, use this skill directly; do not copy Claude plugin commands or persona agents.
